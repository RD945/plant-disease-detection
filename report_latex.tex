...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\textwidth]{images/Sample-images-from-PlantVillage-dataset-for-38-types-of-leaf-diseases.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\textwidth]{images/overpreprocess.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.85\textwidth]{images/mobilenetv2_architecture.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\textwidth]{images/accuracy_and_loss_over_epochs.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.7\textwidth]{images/histogram_equalization.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.7\textwidth]{images/homomorphic_filtering.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\textwidth]{images/compare_all_output.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\textwidth]{images/compare_all_graph.png}
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \includegraphics[width=\textwidth]{images/roc_without_pre.png}
        \caption{ROC Curve (Without Preprocessing)}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.48\textwidth}
        \includegraphics[width=\textwidth]{images/roc_with_pre.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\textwidth]{images/confusuion_matrix.png}
...
\begin{figure}[htbp]
    \centering
    \begin{subfigure}[b]{0.48\textwidth}
        \includegraphics[width=\textwidth]{images/gradcam1.png}
        \caption{Grad-CAM Visualization 1}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.48\textwidth}
        \includegraphics[width=\textwidth]{images/gradcam2.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.6\textwidth]{images/gradcam3.png}
...
\begin{figure}[htbp]
    \centering
    \begin{subfigure}[b]{0.48\textwidth}
        \includegraphics[width=\textwidth]{images/sequential_input.png}
        \caption{Input Image}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.48\textwidth}
        \includegraphics[width=\textwidth]{images/sequential_result.png}
